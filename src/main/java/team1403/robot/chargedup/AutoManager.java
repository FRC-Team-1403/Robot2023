...
public class AutoManager {
  ...
  {
    return new InstantCommand(() -> swerve.autoInit(), swerve).andThen(threePieceAuto);
  }

  public CommandBase getPathPlannerAuto(SwerveSubsystem swerve)
  {
    return new InstantCommand(() -> swerve.autoInit(), swerve).andThen(onePieceAuto);
  }

  public CommandBase getTwoPieceAuto(SwerveSubsystem swerve)
  {
    return new InstantCommand(() -> swerve.autoInit(), swerve).andThen(twoPieceAuto);
  }
}