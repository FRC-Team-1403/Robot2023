...
public interface DeviceFactory {
  ...
  */
  public MotorController makeBrushedCanSparkMax(String name, int channel, 
  ...
  * @return a new MotorController for a CANSparkMax.
  */
  public MotorController makeBrushlessCanSparkMax(String name, int channel,
  					SparkMaxRelativeEncoder.Type encoderType, CougarLogger logger);
  ...
  */
  public MotorController makeCougarTalonFx(String name, int deviceNumber, TalonFXControlMode mode,
					CougarLogger logger);
