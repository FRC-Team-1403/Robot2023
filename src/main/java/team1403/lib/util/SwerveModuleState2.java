...
//Taken from https://github.com/BroncBotz3481/YAGSL/blob/main/swervelib/kinematics/SwerveModuleState2.java
...
public class SwerveModuleState2 extends edu.wpi.first.math.kinematics.SwerveModuleState {
  ...
  public SwerveModuleState2(double speedMetersPerSecond, 
      Rotation2d angle, double angularVelocityRadPerSecond) {
    super(speedMetersPerSecond, angle);
   ...
   * by potentially reversing the direction
   * the wheel spins. Customized from WPILib's version to include placing in
   * appropriate scope for CTRE and REV onboard
   * control as both controllers as of writing don't have support for continuous
   * input.
   *
